...
export default function FooterContact() {
  ...
  return (
    <section id="contact" className="relative pb-20 lg:pb-28 pt-0 px-4 sm:px-6 lg:px-8 bg-brand-cream overflow-hidden select-none">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10 lg:mb-14 space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl font-light tracking-tight text-brand-dark max-w-2xl mx-auto leading-tight font-serif">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="lg:col-span-7 bg-white border border-neutral-200/80 p-6 sm:p-10 rounded-2xl shadow-xl shadow-neutral-950/5 flex flex-col justify-center text-center lg:text-left space-y-4">
            <h3 className="text-xl font-light tracking-tight text-brand-dark font-serif">
            ...
            <div className="text-neutral-600 font-light text-xs sm:text-sm leading-relaxed space-y-4 max-w-2xl text-justify md:text-center lg:text-left">
              <p>
                <strong className="font-medium text-brand-dark">ACE Group</strong> is one of the leading real estate developers in the NCR region, recognized for delivering premium residential developments that combine structural innovation, strict engineering parameters, and ultra-minimal aesthetics.
              </p>
              <p>
