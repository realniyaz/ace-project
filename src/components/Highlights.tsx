...
export default function Highlights() {
  return (
    <section id="highlights" className="relative pb-12 lg:pb-16 pt-0 px-4 sm:px-6 lg:px-8 bg-[#FAF9F5] overflow-hidden flex flex-col justify-between select-none">
      ...
      <div className="max-w-7xl mx-auto w-full space-y-10 relative z-20 pt-10">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 bg-neutral-100 border border-neutral-200 px-3 py-1 rounded-md">
              ...
              {highlightsList.map((item) => (
                ...
                >
                  <div className="flex items-center gap-3.5 w-full justify-start text-left">
                    ...
                    <div className="shrink-0 flex items-center justify-center w-5 h-5 rounded-lg bg-[#991b1b]/10 border border-[#991b1b]/20 text-[#991b1b] group-hover:bg-[#991b1b] group-hover:text-white group-hover:border-[#991b1b] transition-all duration-500 ease-out">
                      <svg 
                    ...
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                      <span className="font-light text-sm sm:text-base text-neutral-700 tracking-wide group-hover:text-neutral-950 transition-colors duration-300">
                        {item.title}
                      </span>
                      
                      {/* Optional Badge Block Reflow */}
                      {item.badge && (
                        <span className="bg-[#991b1b]/10 border border-[#991b1b]/20 text-[#991b1b] text-[8px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-sm shrink-0 select-none">
                          {item.badge}
                        </span>
                      )}
                    </div>
      ...
      {/* Fixed: Tightened layout margin-top rules to streamline footer integration */}
      <div className="relative z-20 max-w-7xl mx-auto w-full border-t border-neutral-200/80 pt-6 mt-6">
        <div className="bg-white border border-neutral-200/80 p-6 rounded-2xl shadow-xl shadow-neutral-950/5 flex flex-col md:flex-row items-center justify-between gap-6 transition-all duration-500 hover:border-neutral-300">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
            <span className="bg-neutral-950 text-white text-[10px] font-bold uppercase tracking-[0.18em] px-3 py-1.5 shrink-0 select-none rounded-lg shadow-xs">
          ...
          <a 
            href="#amenities" 
            className="group relative bg-[#991b1b] text-white font-bold text-xs uppercase tracking-widest px-8 py-4 rounded-xl transition-all duration-500 shrink-0 w-full md:w-auto text-center overflow-hidden shadow-md active:scale-[0.99] cursor-pointer"
          >
